    ...
    for training_file_path in training_file_paths:
        ...
        for regularizer_type in regularizers.keys():
            ...
            for dropout_rate in dropout_rates: 
                ...
                print(f"\nTime taken for training with ragularizer={regularizer_type} and dropout_rate={dropout_rate}: {round(elapsed_training_timer / 60, 2)} minutes\n")
                ...
                model_path = os.path.join(save_dir, f"DeepRNN_{split_used}(NoReg)-{dataset_name}_{count_models}.keras")
