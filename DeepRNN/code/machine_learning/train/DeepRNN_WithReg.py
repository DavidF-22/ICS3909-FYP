...
results_file_path = 'Saves/DeepRNN_training_WithReg_results.txt'
...
def DeepRNN(input_shape, reg_factor, dropout_rate, regularizer, learning_rate):
    ...
    rnn3 = layers.SimpleRNN(units=64, 
                            return_sequences=True, 
                            kernel_regularizer=regularizer, 
                            recurrent_regularizer=regularizer(reg_factor))(dropout2)
    ...
    for training_data_file, training_label_file in zip(training_data_files, training_labels_files):
        ...
        for regularizer_type in regularizers.keys():
            ...
            for reg_factor, dropout_rate in zip(reg_factors, dropout_rates): 
                ...
                # build model
                model = DeepRNN(input_shape, reg_factor, dropout_rate, regularizers[regularizer_type], learning_rate=args.learning_rate)
