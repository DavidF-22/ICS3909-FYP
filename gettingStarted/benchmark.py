...
def main():
    ...
    parser.add_argument(
        "--out_dir", type=str, default=".", help="Output directory for predictions."
    )
    parser.add_argument(
        "--predictors",
        type=str,
        nargs="+",
        default=None,
        help="List of predictors to benchmark.",
    )
    parser.add_argument(
        "--datasets",
        type=str,
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=None,
        help="List of ratios to benchmark.",
    )
    ...
    for dset in datasets:
        for ratio in ratios:
            ...
            input_file = miRBench.dataset.get_dataset_path(
                dset, split=split, ratio=ratio
            )
            ...
            print(
                f"Predictions for {dset} dataset, ratio {ratio}, written to {output_file}"
            )
