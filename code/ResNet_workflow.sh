...
if [ "$2" == "small" ]; then
    ...
    print_error "Invalid argument: '$2' is not recognized. Allowed values: small | medium | large"
    exit 1
fi
...
if [ "$3" == "noreg" ]; then
    ...
    print_error "Invalid argument: '$3' is not recognized. Allowed values: noreg | withreg"
    exit 1
fi
...
TRAINING_DATASETS_PATH="data/ResNet_data/training"
TESTING_DATASETS_PATH="data/ResNet_data/testing"
...
SCRIPT_PATH="code/machine_learning/train/ResNet/$TRAIN_SCRIPT"
...
SAVED_MODELS_PATH="Saves_ResNet_${RESNET_TYPE}_${REG_TYPE}/ResNet_Models"
...
SAVED_PREDICTIONS_PATH="Saves_ResNet_${RESNET_TYPE}_${REG_TYPE}/ResNet_Predictions"
...
mv "$PATH_TO_BASH_LOG" "Saves_ResNet_${RESNET_TYPE}_${REG_TYPE}/"
