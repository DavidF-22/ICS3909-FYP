...
def main():
    ...
    results_file_path = f"Saves_{model_type}_{regularizer_type}/BiLSTM_{regularizer_type}_training_logs.txt"
    save_dir = f"Saves_{model_type}_{regularizer_type}/BiLSTM_Models"
    ...
    for training_data_file, training_label_file in zip(training_data_files, training_labels_files):
        ...
        if config_results:
            ...
            # build final model
            final_model = BiLSTM(input_shape, best_config['dropout_rate'], learning_rate)
