...
usage() {
    echo "Usage: $0 [noncodingRNA | miRNA] [noreg | withreg] [plot_true | plot_false] [seed]"
    echo ""
    echo "Arguments:"
...
TRAINING_SCRIPT_BASENAME=$(basename "$SCRIPT_PATH")
...
SAVED_MODELS_PATH="Saves_BiLSTM_${REG_TYPE}/BiLSTM_Models"
...
SAVED_PREDICTIONS_PATH="Saves_BiLSTM_${REG_TYPE}/BiLSTM_Predictions"
...
mv "$PATH_TO_BASH_LOG" "Saves_BiLSTM_${REG_TYPE}/"
