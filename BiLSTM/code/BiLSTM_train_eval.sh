...
PREDICTIONS_SCRIPT="BiLSTM/code/machine_learning/evaluate/model_predictions.py"
...
EVALUATIONS_SCRIPT="BiLSTM/code/machine_learning/evaluate/model_evaluate.py"
