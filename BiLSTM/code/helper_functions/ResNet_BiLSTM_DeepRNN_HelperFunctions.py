...
def plot_training(save_dir, history, model_type, dataset_name, regularizer_type, dropout_rate, plot_count, reg_factor=None):
    ...
    if reg_factor is not None:
        plot_filename = f'{regularizer_type}_{dataset_name}_dr{dropout_rate}_rf{reg_factor}_plot{plot_count}_train.png'
    else:
        plot_filename = f'{regularizer_type}_{dataset_name}_dr{dropout_rate}_plot{plot_count}_train.png'
...
def compute_metrics(model, val_data, val_labels):
    metrics_dict = {}
    # if validation data is provided, compute metrics on it
...
def train_model(model, epochs, batch_size, training_data, training_labels, model_type, dataset_name, regularizer_type, dropout_rate, save_dir, args, reg_factor=None, val_data=None, val_labels=None):
    ...
    # compute metrics
    metrics_dict = compute_metrics(model, val_data, val_labels)
